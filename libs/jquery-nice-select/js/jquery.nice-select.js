  ...
  $.fn.niceSelect = function(method) {
    ...
    function addIcon(attr) {
        if (typeof attr !== typeof undefined && attr !== false) {
            return '<svg class="icon ' + attr + '"><use xlink:href="/img/svg/icons.svg#' + attr + '"></use></svg>';
        } else {
            return '';
        }
    }
    ...
    function create_nice_select($select) {
      ...
      selected_html = addIcon(selected_class_attr) + $selected.text();
      ...
      $options.each(function(i) {
        ...
        option_html = addIcon(class_attr) + $option.text();
