    ...
    var articleSlider = new Swiper($(this).prev(), {
      ...
      on: {
        ...
        slideChange: function slideChange() {
          ...
          var activeSlide = $('.article-slider._thumbs .swiper-slide').eq(activeIndex);
          var nextSlide = $('.article-slider._thumbs .swiper-slide').eq(activeIndex + 1);
          var prevSlide = $('.article-slider._thumbs .swiper-slide').eq(activeIndex - 1);
